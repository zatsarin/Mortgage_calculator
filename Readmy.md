...
to install app you need just download archive, unzip it to your web server folder and go to the link [http://127.0.0.1/Calc/index.html](http://127.0.0.1:5500/Calc/index.html)  or you can just open the link https://mortgage-calce.netlify.app/ and try it.
